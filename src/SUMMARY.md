...
- [常用 always](./always.md)
  ...
  - [Cmake](always/cmake.md)
  - [Mysql](always/mysql.md)
  ...
  - [DDCA](always/ddca.md)
- [想法 ideas](./ideas.md)
    - [图片饭简体转换](ideas/complex_easy.md)
    - [文档修改对接大模型](ideas/word_gpt.md)
    - [pytorch](ideas/pytorch.md)
    ...
    - [markdown 海报](https://github.com/gcui-art/markdown-to-image?tab=readme-ov-file)
